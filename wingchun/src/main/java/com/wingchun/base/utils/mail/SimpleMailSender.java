package com.wingchun.base.utils.mail;
/**   
 * 简单邮件（不带附件的邮件）发送器   
 */ 
  ...
  */    
    ...
    public boolean sendMail(String title,String content,String type,String tomail) throws Exception{   
    	...
    	//这个类主要是设置邮件   
	     ...
	     mailInfo.setUserName("4407509@qq.com");    
	     mailInfo.setPassword("4407509");//您的邮箱密码    
	     mailInfo.setFromAddress("4407509@qq.com");    
    ...
    public static void main(String[] args){   
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setFromAddress("4407509@qq.com");    
	     mailInfo.setToAddress("4407509@qq.com");    
